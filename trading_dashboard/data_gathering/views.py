"""
This file defines the logic and control flow for handling requests and defines the HTTP responses that are returned.  
"""
...
def news_detail(request, news_index):
    ...
    return render(request, "news_detail.html", {"i_news": i_news})